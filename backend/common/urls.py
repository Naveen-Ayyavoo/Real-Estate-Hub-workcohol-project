...
from .views import RegisterView, LoginView, LogoutView, TokenRefreshView, UserProfileView, ChangePasswordView, RequestEmailVerificationView, VerifyEmailView, PasswordResetRequestView, PasswordResetConfirmView, ProfileView
