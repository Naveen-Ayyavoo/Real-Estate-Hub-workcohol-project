...
# --- Caching (simple in-memory for dev, use Redis/Memcached in prod) ---
CACHES = {
    'default': {
...
# - Use Redis/Memcached for caching in production
# - Serve static/media files via web server (Nginx, etc.)
